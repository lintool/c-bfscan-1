 ...
 * Usage: sh target/appassembler/bin/GenerateStatistics -index [] -collection [] -output [] {-ratio []}
 */
...
public class GenerateStatistics {
	...
	public static void main(String[] args) throws Exception {
		...
		long[] termindexes = new long[cnt + 1];
		long[] termindexes_padding = new long[cnt + 1];
		cnt = 0;
		try {
		...
		bw_termindexes.write("long *termindexes[] = {");
		bw_termindexes.newLine();
		bw_termindexes_padding.write("long *termindexes[] = {");
		bw_termindexes_padding.newLine();
		for (int thread = 1; thread <= 128; thread ++) {
			bw_termindexes.write("(long []) {");
			bw_termindexes_padding.write("(long []) {");
