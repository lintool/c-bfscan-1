...
public class GenerateStatistics_TermSorted {
	private static final Logger LOG = Logger.getLogger(GenerateStatistics_TermSorted.class);
	...
	public static void main(String[] args) throws Exception {
		...
		while ((status = stream.next()) != null) {
			...
			if (docVector.size() > 0) {
				List<Integer> ids = new ArrayList<Integer>(docVector.keySet());
