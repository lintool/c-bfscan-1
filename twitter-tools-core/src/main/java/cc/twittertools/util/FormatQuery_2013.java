...
public class FormatQuery_2013 {
	private static final Logger LOG = Logger.getLogger(FormatQuery_2013.class);
	...
	private static final String LAST_TWEET_TIME = "318513034073100288";
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			while((line = brTopics.readLine()) != null) {
				...
				bw_query.newLine();
				bw_query.write("<title> ");
				for (String s : arr) {
					bw_query.write(s + " ");
				}
				bw_query.write("</title>");
				bw_query.newLine();
				bw_query.write("<querytime> Sun Mar 31 23:59:59 +0000 2013 </querytime>");
				bw_query.newLine();
