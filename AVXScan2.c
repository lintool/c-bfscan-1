  ...
  for (n = 0; n < num_topics; n ++) {
    ...
    if (topics[n][1] == 1) {
      ...
      for (i = 0; i + jump < num_docs; i += jump) {
        ...
        indexsum = doclengths_ordered_padding[i] + doclengths_ordered_padding[i + 1] + doclengths_ordered_padding[i + 2] + doclengths_ordered_padding[i + 3] + doclengths_ordered_padding[i + 4] + doclengths_ordered_padding[i + 5];
