    ...
    if (topics[n][1] == 1) {
      ...
      for (i = 0; i + jump < num_docs; i += jump) {
        ...
        for (j = 0; j < indexsum; j += 8) {
          ...
          if (bits != 0) {
            ...
            scores[pos] = scores[pos] + log(1 + tf_padding[cur + map[bits]] / part2) + log(MU / (doclengths[i + pos] + MU));
          }
        }
      ...
      for (i = 0; i + jump < num_docs; i += jump) {
        ...
        for (j = 0; j < indexsum; j += 8) {
          ...
          if (bits != 0) {
            int pos = doc_pos[cur >> 3];
            scores[pos] = scores[pos] + log(1 + tf_padding[cur + map[bits]] / part3) + log(MU / (doclengths[i + pos] + MU));
          }
        }
      ...
      for (i = 0; i + jump < num_docs; i += jump) {
        ...
        for (j = 0; j < indexsum; j += 8) {
          ...
          if (bits != 0) {
            int pos = doc_pos[cur >> 3];
            scores[pos] = scores[pos] + log(1 + tf_padding[cur + map[bits]] / part4) + log(MU / (doclengths[i + pos] + MU));
          }
        }
      ...
      for (i = 0; i + jump < num_docs; i += jump) {
        ...
        for (j = 0; j < indexsum; j += 8) {
          ...
          if (bits != 0) {
            int pos = doc_pos[cur >> 3];
            scores[pos] = scores[pos] + log(1 + tf_padding[cur + map[bits]] / part5) + log(MU / (doclengths[i + pos] + MU));
          }
        }
      ...
      for (i = 0; i + jump < num_docs; i += jump) {
        ...
        for (j = 0; j < indexsum; j += 8) {
          ...
          if (bits != 0) {
            int pos = doc_pos[cur >> 3];
            scores[pos] = scores[pos] + log(1 + tf_padding[cur + map[bits]] / part6) + log(MU / (doclengths[i + pos] + MU));
          }
        }
      ...
      for (i = 0; i + jump < num_docs; i += jump) {
        ...
        for (j = 0; j < indexsum; j += 8) {
          ...
          if (bits != 0) {
            int pos = doc_pos[cur >> 3];
            scores[pos] = scores[pos] + log(1 + tf_padding[cur + map[bits]] / part7) + log(MU / (doclengths[i + pos] + MU));
          }
        }
      ...
      for (i = 0; i + jump < num_docs; i += jump) {
        ...
        for (j = 0; j < indexsum; j += 8) {
          ...
          if (bits != 0) {
            int pos = doc_pos[cur >> 3];
            scores[pos] = scores[pos] + log(1 + tf_padding[cur + map[bits]] / part8) + log(MU / (doclengths[i + pos] + MU));
          }
        }
      ...
      for (i = 0; i + jump < num_docs; i += jump) {
        ...
        for (j = 0; j < indexsum; j += 8) {
          ...
          if (bits != 0) {
            int pos = doc_pos[cur >> 3];
            scores[pos] = scores[pos] + log(1 + tf_padding[cur + map[bits]] / part9) + log(MU / (doclengths[i + pos] + MU));
          }
        }
      ...
      for (i = 0; i + jump < num_docs; i += jump) {
        ...
        for (j = 0; j < indexsum; j += 8) {
          ...
          if (bits != 0) {
            int pos = doc_pos[cur >> 3];
            scores[pos] = scores[pos] + log(1 + tf_padding[cur + map[bits]] / part10) + log(MU / (doclengths[i + pos] + MU));
          }
        }
      ...
      for (i = 0; i + jump < num_docs; i += jump) {
        ...
        for (j = 0; j < indexsum; j += 8) {
          ...
          if (bits != 0) {
            int pos = doc_pos[cur >> 3];
            scores[pos] = scores[pos] + log(1 + tf_padding[cur + map[bits]] / part11) + log(MU / (doclengths[i + pos] + MU));
          }
        }
